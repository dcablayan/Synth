# Revision Packet: INDEPENDENT CONTRACTOR AGREEMENT
...
This revision packet identifies 3 area(s) of "INDEPENDENT CONTRACTOR AGREEMENT" warranting negotiation or revision, including 2 high-priority item(s). All suggested language is for review by a qualified professional only and does not constitute legal advice.
...
**Why it matters:** Low liability caps leave you with no meaningful recourse for serious failures.
...
**Original language:**
> "Renewal clause language not extracted from document text."

**Suggested replacement language (for professional review):**
> [SUGGESTED FOR PROFESSIONAL REVIEW] Negotiate a shorter notice window (e.g., 30 days) and require affirmative renewal consent.

**Why it matters:** Missing the cancellation window locks you into another full-term commitment.
...
5. Is the IP assignment clause broad enough to cover all work product?
6. Is the non-compete enforceable in our jurisdiction and scope?
